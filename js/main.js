$(document).ready(function() {	
	...
	var sliderCurrentValue = $( "#slider-gold" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 5000 );
	});
	...
	$('#increase-gems').click(function() {
		...
		sliderGems.slider( "value", sliderCurrentGemsValue + 5000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				setTimeout(function() { 
					$console_message.html("Creating packages for Resources");	
					progressBarConsole(38, $('#progressBarConsole'));			
				}, 4000 );
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_gold_msg + "</span> Resources");
				...
				setTimeout(function() {
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_gold_msg + "</span> <span class='console-message-success'>Resources successfully generated</span>");
				...
				setTimeout(function() { 
					$console_message.html("Generating <span class='console-message-connected-item'>" + $console_message_gems_msg + "</span> Resources");
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-connected-item'>" + $console_message_gems_msg + "</span> <span class='console-message-success'> Resources successfully generated</span>");
				...
				setTimeout(function() { 
					$console_message.html("Optimization of generated Resources");	
				...
				setTimeout(function() { 
					$console_message.html("<span class='console-message-error'>SERVER IS FULL!</span>");	
					progressBarConsole(93, $('#progressBarConsole'));			
				}, 10500 );
				setTimeout(function() { 
				...
				setTimeout(function() {
					...
					$console_message.html("GENERATOR WILL CONTINUE AFTER USER CONFIRMS");
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  Are you here for the first time? This is the only legit Coins generator');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'jungs, hören sie nicht zu ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' He only wants all the Coins for himself haha');
